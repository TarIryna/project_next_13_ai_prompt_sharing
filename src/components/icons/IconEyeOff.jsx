const Icon = ({ color = "black" }) => (
  ...
  >
    ...
    />
    <path
      d="M10.5845 10.5859C10.2092 10.961 9.99823 11.4697 9.99805 12.0002C9.99786 12.5308 10.2084 13.0397 10.5835 13.4149C10.9585 13.7902 11.4672 14.0012 11.9977 14.0013C12.5283 14.0015 13.0372 13.791 13.4125 13.4159"
      stroke={color}
      strokeWidth="1"
      strokeLinecap="round"
      strokeLinejoin="round"
